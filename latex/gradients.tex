...
%   		  &= \sum_{i_2\neq i}^n\frac{\partial}{\partial U_{ij}}(P_{i,i_2} 
%  		 - \sum_{i_3,i_4}^{d,d}U_{i,i_3}C_{i_3,i_4}U_{i_2,i_4})^2 
%  		 + \frac{\partial}{\partial U_{ij}}(P_{i,i} 
%  		 - \sum_{i_3,i_4}^{d,d}U_{i,i_3}C_{i_3,i_4}U_{i,i_4})^2\\
%  		 &= \sum_{i_2\neq i}^n
%  		 2(P_{i,i_2} - \sum_{i_3,i_4}^{d,d}U_{i,i_3}C_{i_3,i_4}U_{i_2,i_4})
%  		 (-\sum_{i_4}C_{j,i_4}U_{i_2,i_4})\\
%  	   &+ 2
%  	   (P_{i,i} - \sum_{i_3,i_4}^{d,d}U_{i,i_3}C_{i_3,i_4}U_{i,i_4})
%  	   ( - \sum_{i_4}^{d}C_{j,i_4}U_{i,i_4}) \\
...
%   		 &= \frac{\partial}{\partial U_{ij}}((P_{i,j} 
%   		 - \sum_{i_3,i_4}^{d,d}U_{i,i_3}C_{i_3,i_4}U^T_{i_4,j})^2) \\
%   		 &= 2(P_{i,j} 
%   		 -\sum_{i_3,i_4}^{d,d}U_{i,i_3}C_{i_3,i_4}U^T_{i_4,j})\frac{\partial}{\partial U_{ij}}(P_{i,j} - \sum_{i_3,i_4}^{d,d}U_{i,i_3}C_{i_3,i_4}U^T_{i_4,j}) \\
